...
embarcados demandam SOs eficientes tanto do ponto de vista de desempenho quanto de energia. A plataforma \textit{Parallel Ultra Low Power} (PULP) \citet{PULP-Plataform} foi desenvolvida com base na arquitetura de conjunto de instruções RISC-V, e possui um número ajustável de processadores de acordo com o que for configurado. O \textit{port} de um sistema operacional para esta plataforma é fundamental para gerência de recursos.
